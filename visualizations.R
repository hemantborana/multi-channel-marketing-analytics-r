...
# creating 5+ advanced visualizations for marketing analytics
...
base_path <- "C:/Users/User/projects/S5/dmv-m8-sa"
data_folder <- file.path(base_path, "Generated_data")
viz_folder <- file.path(base_path, "Visualizations")

# create folders if needed
if (!dir.exists(viz_folder)) {
  dir.create(viz_folder, recursive = TRUE)
}
...
# viz 1: channel performance comparison (ggplot2 - grouped bar chart)
...
# viz 2: campaign roas vs budget (interactive plotly scatter)
...
# viz 3: attribution model comparison (ggplot2 - stacked bar)
...
# viz 4: customer journey funnel (ggplot2)
...
# viz 5: campaign efficiency matrix (interactive heatmap)
...
# viz 6: user journey timeline (ggplot2 - timeline)
...
# viz 7: revenue by channel with budget overlay (ggplot2 combo chart)
...
# viz 8: interactive campaign dashboard (plotly combo)
