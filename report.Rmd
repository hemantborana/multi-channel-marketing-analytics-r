...
campaigns <- read.csv("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/campaigns_cleaned.csv")
integrated <- read.csv("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/integrated_data.csv")
channel_perf <- read.csv("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/channel_performance.csv")
user_journeys <- read.csv("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/user_journeys.csv")
```
...
knitr::include_graphics("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/Visualizations/viz1_channel_performance.png")
```
...
knitr::include_graphics("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/Visualizations/viz3_attribution_comparison.png")
```

### Attribution Model Insights

```{r attribution-summary}
attribution <- read.csv("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/attribution_analysis.csv")
...
knitr::include_graphics("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/Visualizations/viz4_conversion_funnel.png")
```
...
knitr::include_graphics("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/Visualizations/viz6_journey_timeline.png")
```
...
htmltools::includeHTML("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/Visualizations/viz2_roas_budget.html")
```

### Revenue vs Budget by Channel

```{r revenue-budget-viz, fig.width=10, fig.height=6}
knitr::include_graphics("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/Visualizations/viz7_revenue_budget_channel.png")
```
...
efficiency <- read.csv("C:/Users/User/projects/S5/dmv-m8-sa/Generated_data/campaign_efficiency.csv")
